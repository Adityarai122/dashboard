...
// This schema is identical to Order but stored in a separate temporary collection
...
// -------------------------------------------------------------------------
// OPTIMIZATION: Compound Index for Uniqueness & Search Performance
// -------------------------------------------------------------------------
PendingOrderSchema.index(
  { 
    ...
    size: 1, 
    lineItemNumber: 1,
    rowSignature: 1 // Add signature to index
  }, 
